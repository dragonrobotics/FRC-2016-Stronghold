...
public class PugstickAttack extends Command {
	...
	protected void execute() {
		// see FireKoala.java for if statement shortcut below
		Joystick stick = Robot.oi.getJoystick();
		// only gives spin if button 2 is pressed
		Robot.pitcher.set(stick.getY(), stick.getRawButton(2) ? stick.getX() : 0);
	}
